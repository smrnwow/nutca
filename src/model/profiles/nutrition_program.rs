...
pub struct NutritionProgram {
    id: String,
    name: String,
    stages: Vec<Stage>,
}

impl NutritionProgram {
    pub fn new() -> Self {
        Self {
...
#[cfg(test)]
mod tests {
    use super::{NutrientAmount, NutritionProgram, Stage};
    use crate::model::chemistry::Nutrient;

    #[test]
    fn new_nutrition_program_has_single_stage() {
        let nutrition_program = NutritionProgram::new();
    ...
    fn new_stage_can_be_added_to_nutrition_program() {
        let mut nutrition_program = NutritionProgram::new();
